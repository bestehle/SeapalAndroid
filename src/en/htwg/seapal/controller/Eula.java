...
public class Eula {
	...
	private static String EULA_ACCEPTED = "EULA_ACCEPTED";
  ...
  public static void showEulaRequireAcceptance(final Activity activity) {
    final SharedPreferences preferences =
        activity.getSharedPreferences(EULA, Activity.MODE_PRIVATE);
    if (preferences.getBoolean(EULA_ACCEPTED, false)) {
      return;
    }
...
private static void accept(Activity activity, SharedPreferences preferences) {
    preferences.edit().putBoolean(EULA_ACCEPTED, true).commit();
  }
